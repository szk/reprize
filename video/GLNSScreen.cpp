...
GLNSScreen::GLNSScreen(NSDepInfo* depinfo_)
    : Screen(depinfo_), ns_info(depinfo_), doublebuffer(false)
{
#ifdef UNDEF
...
void GLNSScreen::begin_paint(void)
{
}

void GLNSScreen::finish_paint(void)
{
}

const bool GLNSScreen::flip(void)
{
#ifdef UNDEF
    if (doublebuffer)
...
const bool GLNSScreen::alloc_extension(void)
{
    // XXX
...
void GLNSScreen::kill_cursor(void)
{
#ifdef UNDEF
