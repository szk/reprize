...
bool Sky::InitSkyParameters()
{
    ...
    betaRayleigh.x = (float)(1.0 / (3.0 * N
                                    * lambdaRed * lambdaRed * lambdaRed * lambdaRed));
    betaRayleigh.y = (float)(1.0 / (3.0 * N
                                    * lambdaGreen * lambdaGreen * lambdaGreen * lambdaGreen));
    betaRayleigh.z = (float)(1.0 / (3.0 * N
                                    * lambdaBlue * lambdaBlue * lambdaBlue * lambdaBlue));
